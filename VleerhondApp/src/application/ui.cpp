...
namespace Vleerhond
{
    ...
    {
        this->last_pressed = Utils::millis();
    }

    void ButtonState::release()
    {
        this->last_released = Utils::millis();
    }

    bool ButtonState::is_pressed() const
    {
        return last_released < last_pressed;
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    void UiState::release_step(const uint8_t id)
    {
        get_step_state(id).release();
    }

    void UiState::press_step(const uint8_t id)
    {
        get_step_state(id).press();
    }
