...
MBase::MBase(Modulators& modulators, TimeStruct& time)
    ...
    // this->params.push_back(CcParam(MBASE_HARMONICS, 0, 127));
    // this->params.push_back(CcParam(MBASE_PULSE, 0, 127));
    // this->params.push_back(CcParam(MBASE_NOISE, 0, 127));
    // this->params.push_back(CcParam(MBASE_ATTACK, 0, 127));
    ...
    // this->params.push_back(CcParam(MBASE_METAL_NOISE, 0, 127));
    ...
    // this->params.push_back(CcParam(MBASE_LFO_INTENSITY, 0, 16));
    // this->params.push_back(CcParam(MBASE_LFO_RATE, 0, 32));
}
}  // namespace Vleerhond